...
# step итерация завершиться либо когда pointer станет больше stop, либо меньше stop.
...
# Создайте несколько объектов класса Iterator и совершите итерации с ними при помощи
# цикла for.
...
class Iterator:
    ...
    def __iter__(self):
        self.pointer = self.start  # сбрасываем указатель на начало
        return self
